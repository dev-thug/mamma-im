...
const faqs: { question: string; answerText: string; answer?: React.ReactNode }[] = [
  ...
  },
  {
    ...
    answerText:
      "육아 에이전트는 부모가 남긴 수유·수면·기저귀·성장 기록을 스스로 읽고, 그 데이터를 근거로 다음에 무엇을 하면 좋을지 제안하는 AI입니다. 기록만 쌓아두는 육아 기록 앱, 일반론만 말하는 AI 챗봇과 달리 우리 아이의 실제 기록을 놓고 답합니다. 맘마는 기록·분석·상담을 한 앱에서 잇는 AI 육아 에이전트입니다.",
  },
  {
